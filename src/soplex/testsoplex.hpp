...
void SoPlexBase<R>::_checkScaling(SPxLPBase<R>* origLP) const
{
   ...
   {
      assert(EQ(origLP->lhs(i), _realLP->lhsUnscaled(i), this->_solver.epsilon()));
      assert(EQ(origLP->rhs(i), _realLP->rhsUnscaled(i), this->_solver.epsilon()));
   ...
   {
      assert(EQ(origLP->lower(i), _realLP->lowerUnscaled(i), this->_solver.epsilon()));
      assert(EQ(origLP->upper(i), _realLP->upperUnscaled(i), this->_solver.epsilon()));
      assert(EQ(origLP->obj(i), _realLP->objUnscaled(i), this->_solver.epsilon()));
